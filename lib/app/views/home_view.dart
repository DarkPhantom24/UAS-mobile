              ...
              child: Obx(() {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    _buildSection('🔥 Trending Now', _hc.trendingMovies),
                    const SizedBox(height: 24),
                    _buildSection('🆕 New Releases', _hc.newReleases),
    ...
    return Obx(() {
      ...
      return SizedBox(
        ...
        child: PageView.builder(
          ...
          onPageChanged: (i) => _hc.updateCarouselIndex(i),
      ...
      child: Container(
        ...
        child: ClipRRect(
          ...
          child: Stack(
            ...
            children: [
              CachedNetworkImage(
                imageUrl: m.gambarSampul.isNotEmpty
                    ? m.gambarSampul
                    : m.gambarPoster,
                fit: BoxFit.cover,
                placeholder: (c, u) => Container(color: AppTheme.cardDark),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        Text(
                          m.skorRating.toStringAsFixed(0),
                          style: const TextStyle(
                            color: AppTheme.accentGold,
                            fontSize: 14,
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (_, i) => MovieCard(
              movie: movies[i],
              onTap: () => Get.toNamed('/detail', arguments: movies[i]),
            ),
          ),
        ),
      ],

...
class SearchView extends StatelessWidget {
  ...
  Widget _buildHeader(BuildContext ctx) {
    return Padding(
      ...
      child: Row(
        ...
        children: [
          const Text('Search', style: TextStyle(fontSize: 28, fontWeight: FontWeight.w800, color: AppTheme.textPrimary)),
  ...
  Widget _buildSearchBar() {
    return Padding(
      ...
      child: Container(
        decoration: BoxDecoration(color: AppTheme.cardDark, borderRadius: BorderRadius.circular(16), border: Border.all(color: AppTheme.glassBorder)),
        child: TextField(
          onChanged: _mc.onSearchChanged,
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                Text(_mc.searchQuery.value.isNotEmpty ? 'No movies found' : 'Start searching for movies', style: const TextStyle(color: AppTheme.textMuted, fontSize: 16)),
              ],
            ),
          ),
        );
  ...
  Widget _sortTile(String label, String mode, IconData icon) {
    return Obx(() {
      ...
      return ListTile(
        ...
        leading: Icon(icon, color: sel ? AppTheme.accentBlue : AppTheme.textMuted),
